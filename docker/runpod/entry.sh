...
if [ -n "$ROAMING_WAN" ] && [ "$ROAMING_WAN" = "1" ]; then
  ...
  aws s3 cp --region EU-RO-1 --endpoint-url https://s3api-eu-ro-1.runpod.io/ s3://kns8p9opbh/models/vae_approx/ /home/comfyuser/ComfyUI/models/vae_approx --recursive
  aws s3 cp --region EU-RO-1 --endpoint-url https://s3api-eu-ro-1.runpod.io/ s3://kns8p9opbh/models/loras/wan/ /home/comfyuser/ComfyUI/models/loras/wan --recursive
  aws s3 cp --region EU-RO-1 --endpoint-url https://s3api-eu-ro-1.runpod.io/ s3://kns8p9opbh/models/clip_vision/ /home/comfyuser/ComfyUI/models/clip_vision --recursive
